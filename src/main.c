...
#define GPIOB_PDDR (*((volatile unsigned int*)0x400FF014))
// Define o endereço do registrador GPIOB_PSOR (SET)
#define GPIOB_PSOR (*((volatile unsigned int*)0x400FF004))
// Define o endereço do registrador GPIOB_PCOR (CLEAN)
#define GPIOB_PCOR (*((volatile unsigned int*)0x400FF008)) 
